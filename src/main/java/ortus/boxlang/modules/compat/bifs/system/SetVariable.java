...
@BoxBIF
public class SetVariable extends BIF {
	 ...
	 *
	 * @argument.name The name of the variable to set.
	 * 
	 * @argument.value The value to set the variable to.
	 */
	public Object _invoke( IBoxContext context, ArgumentsScope arguments ) {
		String	name	= arguments.getAsString( Key._NAME );
		Object	value	= arguments.get( Key.value );
		ExpressionInterpreter.setVariable( context, name, value );
		return value;
	}
